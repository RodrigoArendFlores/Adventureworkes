  ...
  create or replace view `adventureworks-312502`.`dbt_rodrigo`.`stg_businessentityaddress`
  OPTIONS()
  as with
     source as (
         select 
     ...
     from `adventureworks-312502`.`adventure_works`.`businessentityaddress`
     ),
       
       
       /* Transformacao para deixar unico businessentityid*/
     k as (
