  ...
  create or replace view `adventureworks-312502`.`dbt_rodrigo`.`stg_salesorderheadersalesreason`
  OPTIONS()
  as with
     source as (
         select 
     ...
     from `adventureworks-312502`.`adventure_works`.`salesorderheadersalesreason`
     )
     ...
     -- base
         ...
         , final as (
         select n_rep.salesorderid, n_rep.motivo_1, rep_um.motivo_2, rep_dois.motivo_3
         from n_rep
